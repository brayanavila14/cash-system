...
if (isset($_POST['registra'])) {
    ...
    if ( strlen($name) == 0 && strlen($usuario) == 0 && strlen($password) == 0 &&
    strlen($password2)== 0 && strlen($correo) == 0) {
        ...
        strlen($password2)== 0 || strlen($correo) == 0) {
          ...
          return;
            ...
            if (strlen($name) == 0) {
                ?>
                <h3 class="advert name">¡Por favor ingresa el nombre de la empresa!</h3>;
                <?php
            return;
            } else {
                if (strlen($correo) == 0) {
                               ...
                               <h3 class="advert password">¡Por favor ingresa la contraseña!</h3>;
                                ...
                                if (strlen($password) < 5) {
                                    ...
                                    if ($password != $password2) {
                                        ...
                                        $consulta = "INSERT INTO administrador( Nombre, Usuario, Contraseña, Correo) VALUES ('$name', '$usuario', '$password', '$correo')" ;
